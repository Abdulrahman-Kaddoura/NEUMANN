            ...
            >
                <form
                    ...
                    <div className='add-form-header'>
                        <h1 id="add-employee-heading">Edit Employee Details</h1>
                    ...
                    <div className='add-form-buttons'>
                        <button type='submit' disabled={!canSubmit || isPending} title={!canSubmit ? 'No change detected' : undefined} className='add-submit-button'>Submit</button>
